...
To host each portal on its own dedicated subdomain (e.g., `admin.talentflow.io`, `candidate.talentflow.io`, `company.talentflow.io`, `api.talentflow.io`), create 5 separate Projects in Vercel from the same Git repo:

### 1. Project 1: Backend API (`@talent-flow/api`)
...
### 2. Project 2: Admin Panel (`@talent-flow/admin-panel`)
- **Project Name**: `talentflow-admin`
- **Root Directory**: `packages/admin-panel`
- **Framework Preset**: `Vite`
- **Build Command**: `npm run build`
- **Output Directory**: `dist` (or `.output/public` for SSR)
- **Install Command**: `npm install`

### 3. Project 3: Candidate Portal (`@talent-flow/candidate-portal`)
- **Project Name**: `talentflow-candidate`
...
### 4. Project 4: Company Workspace (`@talent-flow/company-portal`)
- **Project Name**: `talentflow-company`
...
### 5. Project 5: Graviton IT Solutions (`@talent-flow/graviton-it-solutions`)
- **Project Name**: `talentflow-graviton`
...
| Variable | Example Value | Description |
| :--- | :--- | :--- |
| `CLIENT_DOMAIN_URL` | `https://candidate.yourdomain.com` | Primary client frontend URL for CORS whitelist |
| `ADMIN_DOMAIN_URL` | `https://admin.yourdomain.com` | Admin panel URL for CORS whitelist |
| `VITE_API_URL` | `https://api.yourdomain.com` | Base API URL configured across frontend portals |
