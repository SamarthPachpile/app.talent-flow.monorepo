...
export const Route = createFileRoute("/offers")({
  head: () => ({
    meta: [
      { title: "Offers & E-Signature — CROTON IT SOLUTIONS" },
      {
        name: "description",
        content:
          "Generate offer letters, send them for e-signature, and track viewed and accepted milestones with a full audit log for every step.",
      },
      { property: "og:title", content: "Offers & E-Signature — CROTON IT SOLUTIONS" },
      {
        property: "og:description",
        content: "Offer generation, secure signature requests and per-step audit logging.",
      },
