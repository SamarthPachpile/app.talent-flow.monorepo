...
export default defineConfig(({ mode }) => {
  ...
  try {
    ...
    // Ignore invalid company domain URL
  }
  ...
  return {
    ...
    resolve: {
      alias: {
        ...
        "@company-portal": path.resolve(__dirname, "./src"),
        "@company-onboarding": path.resolve(__dirname, "./src"),
        "@onboarding": path.resolve(__dirname, "./src"),
        "@talent-flow/company-portal": path.resolve(__dirname, "./src/App.tsx"),
        "@talent-flow/company-portal-client": path.resolve(__dirname, "./src/App.tsx"),
        "@talent-flow/company-onboarding": path.resolve(__dirname, "./src/App.tsx"),
