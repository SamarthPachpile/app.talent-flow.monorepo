...
export const EmployXDashboardOverview: React.FC<EmployXDashboardOverviewProps> = ({
  ...
  return (
    <div className="space-y-3.5 animate-fadeIn font-sans text-slate-800 dark:text-slate-100">
      {/* =========================================================================
          FEATURED CONTENT SECTION: TALENT ACQUISITION & JOB REQUISITION CREATION
         ========================================================================= */}
      <div className="clip-service relative overflow-hidden bg-gradient-to-r from-slate-900 via-slate-850 to-slate-900 border border-slate-800 p-4 sm:p-5 text-white shadow-md">
        ...
        <div className="absolute bottom-0 left-1/3 -mb-16 w-48 h-48 bg-blue-500/10 rounded-full blur-3xl pointer-events-none" />

        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="space-y-1.5 max-w-2xl">
            <div className="flex flex-wrap items-center gap-2">
              <span className="px-2.5 py-0.5 rounded-full bg-orange-500/20 text-orange-400 border border-orange-500/40 text-[10px] font-mono font-bold uppercase tracking-wider flex items-center gap-1">
                <Sparkles className="w-3 h-3 text-orange-400" /> Firestore Requisitions Sync
              </span>
              <span className="text-[11px] text-slate-400 font-medium">
                Target Collection: <code className="text-orange-400 font-mono">jobs/</code>
              </span>
            </div>
            <h2 className="text-lg sm:text-xl font-bold text-white tracking-tight">
              Talent Acquisition & Job Openings Studio
            </h2>
            <p className="text-xs text-slate-300 leading-relaxed">
              Create and publish new job postings stored directly under your company's Firestore
              requisitions document. Candidates can discover and apply across the public Career
              Portal in real-time.
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2.5 shrink-0">
            <button
              ...
              className="clip-path-button-sm px-4 py-2.5 bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white text-xs font-bold shadow-md hover:shadow-lg transition-all flex items-center gap-2 cursor-pointer group"
            >
            ...
            <button
              onClick={() => {
                if (onNavigateTab) onNavigateTab("jobs-list");
              }}
              className="clip-path-button-sm px-3.5 py-2.5 bg-white/10 hover:bg-white/20 text-slate-200 hover:text-white text-xs font-semibold border border-white/15 backdrop-blur-md transition-all flex items-center gap-1.5 cursor-pointer"
            >
            ...
            <button
              ...
              className="clip-path-button-sm px-3.5 py-2.5 bg-slate-800/80 hover:bg-slate-800 text-slate-300 hover:text-white text-xs font-semibold border border-slate-700 transition-all flex items-center gap-1.5 cursor-pointer"
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-3.5 items-stretch">
        ...
        <div className="lg:col-span-4 lg:row-span-2 clip-service bg-white dark:bg-slate-850 p-4 sm:p-5 flex flex-col justify-between h-full w-full shadow-2xs space-y-3">
          <div>
            {/* Header & Timeframe Filter + Post Job Action */}
            <div className="flex items-center justify-between pb-2 border-b border-slate-100 dark:border-slate-800 gap-2">
              ...
              <div className="flex items-center gap-1.5">
                <button
                  onClick={() => setShowCreateJobModal(true)}
                  className="px-2 py-1 bg-orange-500 hover:bg-orange-600 text-white rounded-lg text-[11px] font-bold transition-all flex items-center gap-1 cursor-pointer shadow-2xs"
