...
const NAV = [
  { to: "/admin-panel/settings", label: "General", icon: SlidersHorizontal, exact: true },
  { to: "/admin-panel/settings/templates", label: "Email templates", icon: Mail },
  { to: "/admin-panel/settings/automation", label: "Automation", icon: Zap },
  { to: "/admin-panel/settings/team", label: "Team & roles", icon: Users },
  { to: "/admin-panel/settings/guidelines", label: "Guidelines", icon: BookOpen },
] as const;
    ...
    <div className="min-h-screen bg-background font-sans">
      <header className="border-b border-border bg-surface">
        <div className="px-6 py-6">
          ...
          <h1 className="mt-2 text-4xl leading-none font-display">Settings</h1>
      ...
      <div className="flex flex-col gap-8 px-6 py-8 lg:flex-row max-w-7xl mx-auto">
